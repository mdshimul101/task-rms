  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-5 lg:px-0">
      <div className="group inline-block">
        <h1 className="font-raleWay text-4xl font-thin text-orange-300 ">
          Featured Products
        </h1>
      ...
      <div className="mt-4">
        <div className="grid grid-cols-1  py-10  md:grid-cols-2 lg:grid-cols-3 gap-10">
          {featureItems.map((item) => (
            <div className="m-w-80 overflow-hidden ">
              ...
              <div className="p-4 bg-orange-50">
                ...
                <p className=" font-raleWay font-thin text-gray-400">
                  {item.element}
                </p>
                <div className="flex justify-between items-center mt-5 ">
                  <p className="text-gray-400">Price:{item.price}</p>

                  <div className="text-orange-400 px-4 py-2 border-[1px] border-orange-300  hover:bg-orange-500  hover:text-white ease-linear duration-300">
                    ADD TO CART
                  </div>
                </div>
              </div>
